...
Generative artificial intelligence tools were used in a limited, supporting
capacity during the development and writing of this project. Their use was
restricted to brainstorming, clarification of technical concepts, debugging
assistance, and sentence-level edits for clarity and grammar. These tools were
not used to generate the core research question, system architecture,
experimental outputs, or final conclusions.

During implementation, AI Chatbots (ChatGPT and
occasionally Gemini) were used similarly to interactive technical references.
Typical prompts asked about Python behavior, API usage, data-processing edge
cases, and debugging strategies while building and refining the event-driven
trading simulator. For example, AI assistance was used to clarify
implementation details related to latency instrumentation and order-execution
logic but all final code and design choices
were selected and validated by the author.

AI assistance was also used during writing for small-scale revisions to improve
readability, flow, and grammar. These edits were limited to local phrasing and
did not introduce new claims, sources, or analysis. 

All AI output was treated as advisory only. Suggested content was heevily reviewed,
thouroughly vetted, and verified before inclusion in both code and writing. The author
accepts full responsibility for the correctness (or wrongness) of the implementation and for
all arguments, results, and conclusions presented in this paper.
